...
class AssetProfile:
    ...
    # ── SL / TP ─────────────────────────────────────────────────────
    sl_multiplier: float = 3.0  # Fase 5 4h: 1.5→3.0 (SL muy ajustado para velas 4h, 18/19 SL)
    tp_multiplier: float = 5.0  # Fase5: 4h, SL 3.0 TP 5.0 → RR 1.67
...
ASSET_PROFILES: dict[str, AssetProfile] = {
    ...
    'BTC': AssetProfile(
        ...
        sl_multiplier=3.0,  # Fase5: 4h wide SL
        tp_multiplier=5.0,  # Fase5: 4h TP amplio (SL 3.0, TP 5.0 → RR 1.67)
    ...
    'INJ': AssetProfile(
        ...
        sl_multiplier=3.0,  # Fase5: 4h wide SL  # v3: 1.3→1.8 (SL más amplio → posición más pequeña para mismo riesgo)
        tp_multiplier=5.0,  # Fase5: 4h TP amplio  # v3: 2.6→3.5 (proporcional al SL para mantener R:R ~2:1)
    ...
    'XAU': AssetProfile(
        ...
        confluence_min=3,
        sl_multiplier=3.0,  # Fase5: 4h wide SL
        tp_multiplier=5.0,  # Fase5: 4h TP amplio
